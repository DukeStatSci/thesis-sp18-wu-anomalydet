...
##Network Attacks 
  ...
  The goal of this paper is to devise and evaluate techniques to identify anomalies in incoming network connection data. These techniques will use existing data to inform the process of defining expected behavior between ports. New observations between port connections that are far away from the defined expected behavior may be considered anomalies and investigated for whether they are a form of network attack.
